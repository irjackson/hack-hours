// Given a number, find the "round" of each digit of the number. An integer is called "round" if all its digits except 
// the leftmost (most significant) are equal to zero.
